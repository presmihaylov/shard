...
type Provider interface {
	...
	// Clone starts a new sandbox over a copy of the writable layer sourceID kept, and runs the source's
	// entrypoint from the beginning. It refuses a source that is alive, and it reads nothing else of it.
