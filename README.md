...
the CLI then takes `--remote https://box:2376 --token-file <path>`. See `docs/daemon.md`. On a Mac,
`docs/mac.md` runs that daemon inside one Lima VM and drives it from the native CLI.
